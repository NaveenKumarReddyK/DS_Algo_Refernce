...
//
////Description
//// Find shortest string made from String1 and String2 such that it consists of both String1 and String2
//class Shortest_Common_String {
...
//    }
//
//    public static String longestCommomSubString(String s1, String s2) {
//        int len1 = s1.length();
//        int len2 = s2.length();
...
//        System.out.println(shortestCommonSupersequence(input1,input2));
//        sc.close();
//    }
//}